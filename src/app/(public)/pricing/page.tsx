      ...
      <div className="container">
        <header className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-3xl mx-auto">
            Choose the most convenient way to connect with the doctor. We offer
            transparent pricing and services tailored to your needs.
          </p>
        </header>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <ul className="space-y-3">
                      {consultationFeatures
                        ...
                        .map((item) => {
                          const value = item[planKey as keyof typeof item];
                          return (
                            <li
                              key={item.feature}
