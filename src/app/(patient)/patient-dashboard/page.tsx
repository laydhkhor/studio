           ...
           <section className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Button variant="ghost" size="sm" asChild>
                  <Link href="/patient-dashboard/profile" className="text-primary font-bold">Manage Profile <ArrowRight className="ml-2 h-4 w-4"/></Link>
                </Button>
              </div>
           ...
           <section className="space-y-4">
              ...
              <div className="pt-2 text-center">
                 <Button variant="link" asChild className="text-primary font-bold">
                    <Link href="/patient-dashboard/prescriptions">Browse All Past Reports <History className="ml-2 h-4 w-4"/></Link>
                 </Button>
              </div>
           </section>
        </div>
