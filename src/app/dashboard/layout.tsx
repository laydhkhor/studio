...
export default function DashboardLayout({
  ...
  const currentNavItem = adminNavItems.find(item => item.href === pathname) || adminSettingsNav.find(item => item.href === pathname);
  const pageLabel = currentNavItem?.label || 'Practice';
            ...
            <BreadcrumbList>
              <BreadcrumbItem>
                <BreadcrumbLink asChild>
                  <Link href="/dashboard" className="text-slate-400">Practice</Link>
                </BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage className="font-bold text-slate-900">{pageLabel}</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
